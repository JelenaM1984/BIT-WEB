...
var groceries=[{product: "Milk", quantity: 3, price: 1.50}];
...
var jewelry=[{name:"Rolex",price:500},{name:"Diamond earings",price:600}];
function mostExpensive(){
    ...
    for (var i=0;i<jewelry.length;i++){
        ...
        return "The most expecive jewlery is "+theMostExpencive+" and the price is "+maxPrice;
    }
}
